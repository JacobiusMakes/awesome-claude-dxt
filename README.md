...
- [JacobiusMakes/parlay-api-mcp](https://github.com/JacobiusMakes/parlay-api-mcp) - Python MCP server for sports odds, player props, public discovery, and account usage; account data tools require your own API key and allowances. Published [MCPB 0.3.6](https://github.com/JacobiusMakes/parlay-api-mcp/releases/download/v0.3.6/parlayapi-mcp-0.3.6-directory.mcpb) available.
